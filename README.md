...
## Installation
Voici un résumé du processus et le script à inclure dans ton fichier `README.md` en markdown :
...
Les tests sont organisés en plusieurs catégories pour garantir la qualité de l'application :
...
Cela devrait être suffisant pour une version condensée de ton `README.md`.
### Prérequis
